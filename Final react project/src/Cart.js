  ...
  return (
    <Wrapper>
      <div className="container">
        ...
        {/* add to cart section list-heading menu */}
        ...
        {/* continue shopping button and clear all cart button  */}
        <div className="cart-two-button">
          <NavLink to="/products">
            <Button className="continue-shopping-btn">Continue Shopping</Button>
          </NavLink>
          <Button onClick={clearCart} className="clear-btn btn-clear">Clear Cart</Button>
        </div>

        {/* total amount of our order */}
...
const Wrapper = styled.section`
  ...
  .cart-two-button {
    ...
    .continue-shopping-btn, .clear-btn{
      font-size: 1.4rem;
      letter-spacing: 1px;
    }
